  ...
  <main class="profile-page">
    <section class="relative block h-500-px">
      <div
        ...
        :style="{
          'background-image': communityStore.community.banner
            ? `url('${communityStore.community.banner.url}')`
            : 'none',
        }"
      >
        <NuxtLink :to="`/c/${communityStore.community.id}/settings`">
          <span
            ...
            v-ripple
            :style="{
              backgroundColor: !communityStore.community.banner
                ? colors.SEAGREEN
                : 'none',
            }"
            :class="[
            ...
            <div class="flex flex-wrap justify-center">
                ...
                <div class="relative">
                  <NuxtLink :to="`/c/${communityStore.community.id}/settings`">
                    <NuxtImg
                      ...
                      alt="Avatar"
                      :src="
                        communityStore.community.avatar
              ...
              >
                <div class="py-6 flex flex-col gap-2 px-3 mt-32 sm:mt-0">
                  <NuxtLink
                    v-if="
                      userStore.user?.id === communityStore.community.ownerId
                    "
                  ...
                  <CommunitySubscribeButton
                    ...
                    :isSubscriber="
                      communityStore.community.subscribers
                        ? isSubscriber(communityStore.community.subscribers)
                        : false
                    "
                  />
                </div>
                ...
                <div class="flex justify-center py-4 lg:pt-4 pt-8">
                  ...
                  <div class="mr-4 p-3 text-center">
                    <span
                      class="text-xl font-bold block uppercase tracking-wide text-blueGray-600"
                      >{{
                        communityStore.community.posts
...
const formattedCreatedAt = computed(() =>
  formatDate(
    communityStore.community ? communityStore.community.createdAt : new Date(),
  ),
);

const likesAmount = computed(() =>
  communityStore.community.posts
    ? communityStore.community.posts.reduce(
...
const fetchCommunity = async () => {
  try {
    ...
    const fetchedCommunity = await communityService.getCommunity(
