<template>
  <div class="flex flex-col pb-4 w-full">
    <div class="text-2xl font-bold w-full leading-10 text-oxford">Настройка темы</div>
    ...
    <div class="flex flex-col">
      <div class="text-xl font-bold w-full leading-10 text-oxford">Темная тема</div>
