<template>
  <div class="flex flex-col pb-4 w-full">
    ...
    <div class="text-sm font-medium w-full leading-5 text-slate-500">
      ...
      deserunt doloremque unde enim quaerat!
    </div>
...
const nameRules = ref([(v: any) => !!v || "Name is required"]);
...
const fullNameRules = ref([(v: any) => !!v || "Full name is required"]);
