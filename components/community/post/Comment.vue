<template>
  <div class="pl-20 border-l-2 border-slate-200 my-5 w-full bg-white">
    <div class="flex w-full items-center justify-between">
      <div class="flex items-center space-x-3">
        <div
          ...
          :style="{
            backgroundImage: comment.owner.avatar
    ...
    <div class="flex mt-2 items-center justify-end">
      ...
      <UiButton
        v-if="
          comment.owner.id === userStore.user?.id ||
          userStore.user?.id === communityStore.community.owner.id
        "
        @click="deleteComment"
        mode="text"
        density="compact"
...
const formattedCreatedAt = computed(() =>
  formatTimeElapsed(props.comment.createdAt),
);
